    ...
    if(isset($_REQUEST['action']))
    {
        switch($_REQUEST['action'])
        {
            ...
            case 'registrar':
                ...
                break;
            case 'eliminar':
                $model->Eliminar($_REQUEST['codcli']);
                header('Location: cliente.php');
                break;
            case 'editar':
                $alm = $model->Obtener($_REQUEST['codcli']);
                break;
        }
    }
?>
           ...
           <div class="row">
                ...
                <div class="col-md-9">
                   ...
                   <nav class="navbar navbar-default">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="?action=<?php echo $alm->codcli ?'actualizar' : 'registrar'; ?>" method="post" role="form" enctype="multipart/form-data">
                                <center><h2>Ingrese los datos requeridos</h2></center>
                                <fieldset class="form-group">
                                    <input type="hidden" name="codcli" placeholder="Código " required size="10" class="form-control" value="<?php echo $alm->__GET('codcli'); ?>"><br>
                                 ...
                                 <center>
                                     <input type="submit" value="Añadir cliente" class="btn btn-info"><br><br>
                                 </center>
                            </form>
                        </div>
                    </div>
                    <script>
                        ...
                        var respuesta = confirm("estas seguro de eliminar el cliente");
                        if(respuesta == true)
                        {
                             return true;
                         }else{
                        ...
                        <div class="col-md-12">	
                            ...
                            <table class="table table-condensed">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="?action=editar&codcli=<?php echo $r->codcli; ?>">Editar</a>
                                    </td>
                                    <td>
                                    <a href="?action=eliminar&codcli=<?php echo $r->codcli; ?>" onclick="return confirmdelete() ">Eliminar</a>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
                            </table>
